...
function cmCreateProductviewTag(productID, productName, categoryID, cm_ven, cm_cat, cm_pla, cm_ite, custID, linkShareID,attributes,cm_vc) {
  ...
  cmMakeTag(["tid","5","pi", "MBL: " + "PRODUCT: " + productName + " (" + productID + ")","pr",productID,"pm",productName,"cg",categoryID,"pc","Y","cm_vc",cm_vc?cm_vc:cmExtractParameter("cm_vc",document.location.href),"pv1",custID,"pv2",linkShareID,"cmAttributes",attributes]);
}
